...
momo.series <- my.skeleton.interpolation(P1,P2,n=10,Skeleton.st,j.list,bones,fix.bone=1)
```
...
for(i in 1:length(bones)){
  ...
  b.v[13,] <- c(-0.6,0.1,-0.8) # FemurL
  b.v[14,] <- c(0.1,0.9,0.6) # UlnarR
  b.v[15,] <- c(0.2,0.6,0) # UlnarL
  b.v[16,] <- c(0.1,0.9,0.6) # HandR
  b.v[17,] <- c(0.2,0.6,0) # HandL
  b.v[18,] <- c(0.5,0.1,0.5) # Racket Shuft
  # b.v[20,] <- b.v[18,] # Racket Face 固定
